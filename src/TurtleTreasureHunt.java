...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if (tortoiseLocationX == 505 && tortoiseLocationY == 300) {
			JOptionPane.showMessageDialog(null, "The key to my prison's lock hangs on a ridge, placed by the soldier whom guarded my prison. It glows mysteriously, making it noticeable to a sharp eye. *Hint: The deck above...");
		}
		// 7. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if (tortoiseLocationX == 615 && tortoiseLocationY == 40) {
			JOptionPane.showMessageDialog(null, "You found the key and (un)successfully completed your quest. You may now call FedEx, unlock the girl's prison's lock, package the key, and hand it to the FedEx employee, then wait for your painful death. Good Job and hope you enjoy your doom! :)");
		}
	}
